...
var exportFrameAtTime = function exportFrameAtTime(timeSec, cacheKey) {
  return $._PPP_.exportFrameAtTime(timeSec, cacheKey);
};
var exportFramesBatch = function exportFramesBatch(frames) {
  return $._PPP_.exportFramesBatch(frames);
};
var clearThumbnailCache = function clearThumbnailCache() {
 ...
 * Adobe Media Encoder를 사용하여 비동기적으로 압축
 */
var compressVideoForUpload = function compressVideoForUpload(inputPath, outputDir, presetPath, requestId) {
 ...
 */
var getCompressionPresetPath = function getCompressionPresetPath() {
 ...
 * 임시 폴더 경로 반환
 */
var getTempFolder = function getTempFolder() {
 ...
 * 블로킹 방식으로 완료까지 대기
 */
var exportSequenceDirect = function exportSequenceDirect(sequenceId, outputPath, presetPath, workAreaType) {
 ...
 * - 렌더링 후 원래 상태로 복원
 */
var exportClipDirect = function exportClipDirect(sequenceId, trackIndex, startTimeSec, endTimeSec, outputPath, presetPath) {
